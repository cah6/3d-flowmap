...
function loadMetrics(queryStr, onSuccess, onFailure, applicationName = DEFAULT_APP) {
    appdApplicationApiCall("metric-data?" + queryStr, onSuccess, onFailure, applicationName)
}
